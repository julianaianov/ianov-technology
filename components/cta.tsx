      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            {/* Vídeo de fundo - tema transformação digital / tecnologia */}
            <div className="relative rounded-xl overflow-hidden border border-border bg-muted/20 aspect-[4/3] lg:aspect-auto lg:min-h-[400px]">
              <video
                autoPlay
                muted
                loop
                ...
                aria-label="Vídeo de fundo - transformação digital"
              >
                <source
                  src="https://assets.mixkit.co/videos/46631/46631-720.mp4"
                  type="video/mp4"
                />
              </video>
